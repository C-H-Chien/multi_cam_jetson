...
## CH Notes
Using NVIDIA `ncu` command to profile the performances, specifically the number of FLOPs:
```bash
sudo /opt/nvidia/nsight-compute/2023.2.2/ncu --metrics smsp__sass_thread_inst_executed_op_fadd_pred_on,smsp__sass_thread_inst_executed_op_ffma_pred_on,smsp__sass_thread_inst_executed_op_fmul_pred_on --export popsift_flops ./popsift-match -l /home/jetsonlems/hetlf_326766299.jpg -r /home/jetsonlems/hetrf_326766299.jpg
```
and to see the profiling result through `ncu-ui`, run
```bash
sudo /opt/nvidia/nsight-compute/2023.2.2/ncu-ui popsift_flops.ncu-rep
```
